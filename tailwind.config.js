...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      sm: ['1.6rem', { lineHeight: '2.5rem' }],
      base: ['2.1rem', { lineHeight: '2.4rem', letterSpacing: '0.05em' }], //  info mobile
      lg: ['2.5rem', { lineHeight: '3.5rem', letterSpacing: '0.025em' }], // login row
      // xl: ['1.25rem', { lineHeight: '1.75rem' }],
      '2xl': ['3.5rem', { lineHeight: '4.2rem' }], // info desktop
    ...
    fontFamily: {
      ...
      serif: ['SainteColombe-Light', 'ui-serif', 'Georgia', 'Cambria', '"Times New Roman"', 'Times', 'serif'],
      // mono: [
      //   'ui-monospace',
      //   'SFMono-Regular',
      //   'Menlo',
    ...
    height: (theme) => ({
      ...
      '5/6': '83.333333%',
      full: '100%',
      full_px: 'calc(100% + 1px)', 
      screen: '100vh',
      '25vh': '25vh',
      '50vh': '50vh',
      '110vh': '110vh',
      'menu-item': 'calc((100vw - 2rem * 5) / 5 * 5/4)',
    }),
    ...
    width: (theme) => ({
      ...
      min: 'min-content',
      max: 'max-content',
      '20vw_-0375': 'calc(20vw - 0.375rem)',
      '40vw_-075': 'calc(40vw - 0.75rem)',
      'full_34': 'calc(100% + 3.4rem)',
      'full_35': 'calc(100% + 3.5rem)',
      'full_70': 'calc(100% + 7rem)',
      'full_140': 'calc(100% + 14rem)',
    }),
    zIndex: {
      auto: 'auto',
      0: '0',
